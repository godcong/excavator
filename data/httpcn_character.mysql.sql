...
CREATE TABLE character ( ch VARCHAR (1) PRIMARY KEY COMMENT '汉字' ,
is_regular BOOLEAN NOT NULL COMMENT '常用' ,
pin_yin TEXT NOT NULL COMMENT '拼音' ,
is_duo_yin BOOLEAN NOT NULL COMMENT '多音字' ,
is_surname BOOLEAN COMMENT '姓氏' ,
