...
type RequestFunc func(wd string, qb int) (*http.Request, error)
...
type GrabReader func(wd string, qb ...int) (reader io.ReadCloser, err error)

func (q *Query) Grab(radicalType RadicalType) GrabReader {
	r := requestList[radicalType]
	return func(wd string, qb ...int) (reader io.ReadCloser, err error) {
		arg := 0
		if len(qb) > 0 {
			arg = qb[0]
		}
...
func HanChengBushouRequest(wd string, qb int) (*http.Request, error) {
	// Generated by curl-to-Go: https://mholt.github.io/curl-to-go
...
func HanChengPinyinRequest(wd string, qb int) (*http.Request, error) {
	// Generated by curl-to-Go: https://mholt.github.io/curl-to-go
...
func KangXiBushouRequest(wd string, qb int) (*http.Request, error) {
	// Generated by curl-to-Go: https://mholt.github.io/curl-to-go
	body := strings.NewReader(`wd=` + url.QueryEscape(wd))
	req, err := http.NewRequest("POST", "http://hy.httpcn.com/bushou/zi/", body)
	if err != nil {
...
func KangXiPinyinRequest(wd string, qb int) (*http.Request, error) {
	// Generated by curl-to-Go: https://mholt.github.io/curl-to-go
	body := strings.NewReader(`wd=` + wd)
